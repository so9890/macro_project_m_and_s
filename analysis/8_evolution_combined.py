...
plt.savefig("../out_figures/comparison_evolution/combined_p10_evolution",bbox_inches='tight')
plt.clf()
...
plt.legend(loc=2)
plt.xticks(real_90['time'][1:-1][::8],rotation=70)
plt.xlabel("Time")
plt.ylabel("Well being")
plt.savefig("../out_figures/comparison_evolution/combined_p90_evolution",bbox_inches='tight')
plt.clf()
