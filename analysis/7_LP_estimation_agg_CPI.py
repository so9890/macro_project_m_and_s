...
plt.savefig("../out_figures/CPIU_agg_app/real_ineq_stdev", bbox_inches="tight")
plt.clf()
...
plt.ylabel("Gini")
plt.xticks(data.loc[:157]["mm/yyyy"][::8], rotation=70)
plt.savefig("../out_figures/CPIU_agg_app/real_ineq_Gini", bbox_inches="tight")
plt.clf()
...
plt.ylabel("p90-p10")
plt.xticks(data.loc[:157]["mm/yyyy"][::8], rotation=70)
plt.savefig("../out_figures/CPIU_agg_app/real_ineq_p90-p10", bbox_inches="tight")
plt.clf()
